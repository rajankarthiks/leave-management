$(document).on("click", "#delete_base_product", function () {
    var baseProductId = $("#delete_base_product").data('id');
    $("#baseProductId").val( baseProductId );
});

$(document).on("click", "#delete_product", function () {
    var ProductId = $("#delete_product").data('id');
...
$(document).ready(function(){
	...
	if ($('#datatable-baseProducts').length > 0){
		$('#datatable-baseProducts').dataTable();
	}
